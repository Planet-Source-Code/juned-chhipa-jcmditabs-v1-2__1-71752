VERSION 5.00
Begin VB.UserControl jcMDITabs 
   BackColor       =   &H00FFFFFF&
   ClientHeight    =   2250
   ClientLeft      =   0
   ClientTop       =   0
   ...
   Picture         =   "jcMDITabs.ctx":0000
   ScaleHeight     =   150
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   253
   ToolboxBitmap   =   "jcMDITabs.ctx":0C42
   Begin VB.PictureBox picDefault 
      Height          =   255
      Left            =   1560
      Picture         =   "jcMDITabs.ctx":0F54
      ScaleHeight     =   195
      ScaleWidth      =   225
      TabIndex        =   0
      Top             =   840
...
'****************************************************************************
'*  Title:        jcMDITabs ver 2.0 (ActiveX Control)                       *
...
'****************************************************************************
'* jcMDITabs is an ActiveX control that allows you to quickly provide       *
